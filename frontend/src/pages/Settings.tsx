    ...
    <div className="space-y-4">
      ...
      <Card className="p-6">
        ...
        <p className="text-sm text-muted-foreground">
          Configure API keys, LLM provider, and upload your primary resume.
          Keys are stored in your browser and sent as headers to the backend on each request.
        </p>
      </Card>
          ...
          {settings.llm_provider === "ollama" && (
            <>
              ...
              <p className="text-xs text-muted-foreground">
                Default: qwen2.5:1.5b (simple) / qwen3:1.7b (complex). Pull with:{" "}
